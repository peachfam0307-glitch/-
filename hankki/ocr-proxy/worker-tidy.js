...
5. ingredients 는 반드시 "이름 분량" 꼴로 적어라. 손질 상태만 빼고 분량은 «그대로» 남겨라.
   ...
   ⛔⛔ 단위 «글자»를 절대 바꾸지 마라 — 원문에 적힌 글자를 그대로 옮겨라.
      T·t·g·ml·컵·스푼·큰술·작은술을 다른 말로 «옮기지 마라».
      ⭐ 참고로 «T» 는 큰술, «t» 는 작은술이다. 크기가 3배 다르다 — 바꾸면 맛이 바뀐다.
      (예: "배 12T"→"배 12T"  ⛔"배 12작은술" 아님 ⛔"배 12큰술" 아님
           "고추기름 1/2T"→"고추기름 1/2T"  ·  "참기름 2t"→"참기름 2t"
           "설탕 2/3스푼"→"설탕 2/3스푼"  ⛔"설탕 2/3큰술" 아님)
6. 순서는 조리 동작만. 인사말·후기·팁은 memo 로. 괄호 안 설명도 버리지 마라.
   ...
   ⛔ steps 에서도 단위 «글자»를 바꾸지 마라 — 5번과 같다.
