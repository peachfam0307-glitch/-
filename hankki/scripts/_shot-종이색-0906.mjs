...
const OUT = process.env.SCRATCH + (process.env.SKINS ? '/종이색' : process.env.PROMO ? '/속지6-홍보' : '/속지6'); mkdirSync(OUT, { recursive: true })
...
const 시안들 = process.env.SKINS ? [
  ...
  { 이름: 'd-크림-틀없음', art: 'none', skin: 'cream', rule: 'lined' },
  { 이름: 'e-그레이지-틀없음', art: 'none', skin: 'greige', rule: 'lined' },
] : [
