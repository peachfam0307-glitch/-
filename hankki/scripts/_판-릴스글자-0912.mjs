...
const 판들 = [
  // ⭐ [창업자 2026-09-12] *"1.2.3의 내용을 1-2장으로 압축하고 겹치는걸 최소화"*
  //    -> 1·3 이 둘 다 «홈 화면»이라 겹쳤다. 두 장으로 줄이고 화면을 목록/홈으로 갈랐다.
  ['01-출시', '8월 21일 출시 · 신상 레시피앱 「한끼」', '레시피 87편이 들어 있어요 · 9월 11일 기준'],
  ['03-주기', '매주 6편씩 새로 열려요', '제철 · 우리집 · SNS'],
  ['04-지난', '8·9월 제철 레시피는', '오징어 깻잎 토마토 햅쌀 꽃게'],
  ['05-앞으로', '앞으로는', '가지 버섯 고구마 대하 고등어'],
  ['06-SNS', 'SNS에서 본 레시피도 담겨 있어요', '원작자 글과 영상이에요'],
