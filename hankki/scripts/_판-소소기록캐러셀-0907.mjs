...
const 장들 = {
  ...
  '소소3-03-메모': () => D({ no: 3, 머리: '레시피에<br>내 메모를 적어요',
    ...
    조각들: 조각({ 파일: '04-상세-포스트잇', y: 1020, h: 440, 배율: 0.74, 회전: -2, left: 60, top: 520 }) + 테이프(110, 500),
  ...
  '소소3-04-요리모드': () => F({ no: 4, 위글: '손에 물 묻은 채<br>꺼진 화면을 자꾸 톡톡', 머리: '요리하는 동안<br>화면이 안 꺼져요', 부제: '요리모드로 들어가면 단계마다 큰 글씨<br>타이머도 그 단계에서 바로', 부제폭: 440,
    조각들: 조각({ 파일: '05-요리모드-화면안꺼짐', y: 1950, h: 560, 배율: 0.40, 회전: -2, left: 500, top: 800, z: 6 }),
...
${조각({ 파일: '10-설정-테마', y: 1320, h: 980, 배율: 0.34, 회전: -6, left: 545, top: 350, z: 6, 테: false, r: 22 })}
