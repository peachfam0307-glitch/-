...
const 장들 = {
  '소소1-01-표지': () => A({ no: 1, 태그: '소소한 기능 ①', 그림: '01-냉장고추천', 잘라: 110, 머리: '장 봐 오면<br>그다음은 한끼가', 부제: '영수증 → 냉장고 → 오늘 메뉴 → 장보기까지<br>장보기 탭 하나에 다 있어요', 스티커: 'duos_04', 스자리: 'right:40px;top:400px;width:380px;transform:rotate(-4deg)' }),
