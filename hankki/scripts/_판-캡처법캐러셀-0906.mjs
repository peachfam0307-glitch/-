...
const OUT = process.env.OUT || '/tmp/claude-0/-home-user-hankki/0848ab85-00e3-56db-9a26-e87075950c12/scratchpad/캡처법캐러셀'
...
const 치수 = { gp_gomhi: [593, 667], gp_gomtb: [581, 698], gp_gomft: [572, 699], gp_gomv: [548, 663], pjs_01: [427, 551], pjs_03: [401, 552], pjs_05: [486, 546], pjs_07: [486, 546], duos_02: [595, 533], duos_06: [620, 475] }
const 폭 = (k) => { const [w, h] = 치수[k] || [1, 1]; const H = /^gp_gom/.test(k) ? 400 : /^pjs_/.test(k) ? 360 : 380; return Math.round(H * w / h * 0.8) }
...
${곰 ? `<img class="duo" style="width:${폭(곰)}px" src="${스티커(곰)}">` : ''}
