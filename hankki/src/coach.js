...
// 🔑 «한 번만 뜨는 안내»가 이 접두어를 빌려 쓸 수 있게 내보낸다 — 그러면 `SEED_COACH_SEEN` 을 쓰는 검사판 295개가
//    그 안내도 «본 상태»로 연다(2026-09-06 로그인 안내 팝업이 재현판 4개를 덮어 스모크가 죽었다 · 9/1 소식 팝업과 같은 사고).
//    ⛔ `COACH` 목록엔 «안» 넣는다 — 그건 「기능 안내 다시 보기」가 지우는 목록이라 안내가 또 뜬다.
export const COACH_NS = NS
