...
// 🍽 [2026-08-26] 창업자 「그릇」 컷 108개 — 새 세대 접두어 gr_ (시트 18장)
  ...
  gr_328: 1.0591,
  gr_329: 1.0699,
  gr_330: 1.0668, gr_002: 1.1624, gr_003: 0.9525, gr_004: 1.0925, gr_005: 1.1069, gr_006: 1.1041,
  gr_007: 1.1689, gr_008: 1.188, gr_009: 1.1858, gr_010: 1.1486, gr_011: 1.1402, gr_012: 1.1622,
  gr_013: 1.1736, gr_014: 0.4717, gr_015: 0.533, gr_016: 1.0818, gr_017: 1.1865, gr_018: 0.491,
  gr_019: 1.4887, gr_020: 1.4046, gr_021: 1.5404, gr_022: 1.4199, gr_023: 1.4596, gr_024: 1.4408,
  gr_025: 1.1726, gr_026: 1.2027, gr_027: 1.1897, gr_028: 1.1549, gr_029: 1.1615, gr_030: 1.1801,
  gr_031: 1.1557, gr_032: 1.2174, gr_033: 1.1757, gr_034: 1.1463, gr_035: 1.1596, gr_036: 1.1729,
  gr_037: 1.218, gr_038: 1.2122, gr_039: 1.2087, gr_040: 1.1844, gr_041: 1.2812, gr_042: 1.1751,
  gr_043: 1.1582, gr_044: 1.1497, gr_045: 1.153, gr_046: 1.1629, gr_047: 1.1154, gr_048: 1.1989,
  ...
  gr_067: 1.0046, gr_068: 1.1333, gr_069: 1.0147, gr_070: 1.0651, gr_071: 1.1211, gr_072: 1.1192,
  gr_073: 1.1003, gr_074: 1.1224, gr_075: 1.141, gr_076: 1.0727, gr_077: 1.0842, gr_078: 1.1042,
  gr_079: 1.1791, gr_080: 1.2033, gr_081: 1.1923, gr_082: 1.1463, gr_083: 1.191, gr_084: 1.1516,
  gr_085: 1.2136, gr_086: 1.273, gr_087: 0.6333, gr_088: 1.2268, gr_089: 1.2567, gr_090: 0.5644,
  gr_091: 1.1889, gr_092: 1.2173, gr_093: 1.1911, gr_094: 1.1989, gr_095: 1.2219, gr_096: 1.2247,
  gr_097: 1.1039, gr_098: 1.1173, gr_099: 1.1403, gr_100: 1.0918, gr_101: 1.1154, gr_102: 1.133,
  gr_103: 1.1237, gr_104: 1.1311, gr_105: 1.1417, gr_106: 1.1214, gr_107: 1.1351, gr_108: 1.141,
...
//    ⛔ 「초간단 순살 갈비찜」은 여기 없다 — 창업자가 *"이건 갈비살이구나 내가 다시뽑아줄게"*
  fe_314: 1.1796, fe_316: 1.1753, fe_318: 1.1791, fe_319: 1.2277,
  fe_322: 1.1292, fe_323: 1.1257, fe_324: 1.1347, fe_325: 1.2123, fe_326: 1.1417,
...
//   ⛔ 옛 파일은 «지우지 않았다» — 그 키로 저장한 레시피가 깨진다(픽커·규칙에서만 새 키를 가리킨다)
  ...
  fe_452: 1.1990, fe_453: 1.2010, fe_454: 1.1740, fe_456: 1.1830, fe_457: 1.0230, fe_458: 1.0300,
...
// 🍚 한식 완성요리 뉴세트(2026-07-23·37종, 진짜 음식같은 아이콘 → 레시피 썸네일 자동매칭용). docs/stickers/음식아이콘-2507
  fh_k02: 1.2421, fh_k06: 1.1436,
  fh_k07: 1.1026, fh_k08: 1.1921, fh_k10: 1.2436, fh_k11: 1.2654,
  fh_k14: 1.2322, fh_k18: 1.2523,
  fh_k19: 1.1038, fh_k22: 1.1386,
  fh_k26: 1.0979, fh_k29: 1.0934,
  fh_k34: 1.2163,
// 🍝🥢🍣🥟 양식·중식·일식·분식 완성요리 뉴세트(2026-07-23·51종, blob 깨끗컷 → 레시피 썸네일 자동매칭용). docs/stickers/음식아이콘-2507
  fb_b02: 1.1545, fb_b09: 0.5218,
// 🍱 예시 레시피 보충 세트(2026-07-24·15종, 덮밥·포케·불고기·전골·스무디 등 → 예시 레시피 전용 아이콘). 창업자 생성·blob 컷.
  fe_01: 1.1393, fe_02: 1.1253, fe_03: 1.139, fe_07: 1.15,
  fe_11: 1.2184, fe_14: 1.2063,
// 🍱 예시 보충 2차(2026-07-24·6종, 창업자 생성). 카레·크루키·불닭냉면·요거트아이스크림·김치볶음밥·참치김치감태주먹밥.
  fe_17: 1.1483, fe_18: 1.0973, fe_19: 1.1274,
...
// 🍱 추가 32종 (2026-07-28 창업자 제공) — 인식 안 되던 것 대응(덮밥·조림·치킨·전복·볶음) + 범용 조리법(무침·국·장류) + 양식·중식·빵·음료
  fe_65: 1.2253,
  fe_75: 1.2107, fe_76: 1.3774, fe_77: 1.3648,
  fe_91: 1.1616, fe_92: 1.2053,
...
//       **제목이 엉뚱한 아이콘에 걸리던 자리**(두루치기·깍두기·김치전)를 메운다.
  fe_104: 1.0782, fe_105: 1.1575, fe_107: 1.2322, fe_108: 1.1218,
  fe_111: 1.1228, fe_114: 1.1443,
  fe_115: 1.1798, fe_116: 1.1222,
  fe_121: 1.2164,
  fe_133: 1.245,
// 🍳 2026-08-02 창업자 시트 6컷 — 8월 주간 레시피용(범용 「볶음·회·파전」으로 때우던 자리)
  fe_134: 1.2547, fe_135: 1.1808, fe_136: 1.1328,
...
// 🍂 가을·추석·핼러윈·크리스마스 (창업자 2026-07-30 제공 112컷) — 실제 PNG 크기로 계산
  ...
  // 🐻🍂 [2026-09-05] 꼬르곰 가을 «정본» 8컷 — 창업자가 다시 뽑아 준 시트 2장(외곽선 안 끊김 · cut.py 가드 통과) · 카드 전용
  au_g01: 0.8401, au_g02: 0.7731, au_g03: 0.8622, au_g04: 0.8351, au_g05: 1.0243, au_g06: 0.6484, au_g07: 0.8951, au_g08: 0.5846,
...
//    ⛔ pc1_ = 가을이라 10/1 에 연다 · pc2_·pc3_ 은 기본으로 깔린다(창업자 확정 2026-09-01)
  ...
  pc1_05: 0.8616, pc1_06: 0.854, pc1_07: 0.8472, pc1_08: 0.8799,
  pc2_01: 0.9176, pc2_02: 0.9571, pc2_03: 0.9938, pc2_04: 0.9778,
  pc2_05: 0.9633, pc2_06: 0.9525, pc2_07: 0.9625, pc2_08: 0.9456,
  pc3_01: 0.9313, pc3_02: 0.8663, pc3_03: 0.8424, pc3_04: 0.9049,
  pc3_05: 0.9075, pc3_06: 0.8805, pc3_07: 0.8659, pc3_08: 0.8721,
// 🖼 [2026-09-01] 프레임 12컷 — 창업자가 «투명으로 뚫어» 보낸 판 셋
//    pf_ck = 요리 소품 프레임(모자·리본·포크·클립보드 …) · pf_fd = 음식 프레임
//    ⛔ 이름이 pf_ 로 시작해야 한다 — DecorEditor.isBacking 이 접두어로 «밑판»을 가른다
  pf_ck01: 0.9789, pf_ck02: 1.0072, pf_ck03: 1.0017, pf_ck04: 0.8806,
  pf_ck201: 1.0964, pf_ck202: 1.0364, pf_ck203: 1.0261, pf_ck204: 1.0102,
  pf_fd01: 0.9709, pf_fd02: 0.923, pf_fd03: 1.0051, pf_fd04: 1.0068,
// 🍱 [2026-09-01] 창업자 음식 컷 6장 — 소불고기·찐옥수수·무생채·제육볶음·오징어애호박덮밥·마라탕
  n0101: 1.0896, n0102: 1.1212, n0103: 1.1253, n0104: 1.074,
  n0105: 1.1066, n0106: 1.0949,
...
//     pj_01 ← pp01_01  오므라이스 접시를 들고 있다
//     pj_02 ← pp02_02  냄비에 요리한다        ⭐ 펭펭이 «요리하는» 컷이 앱에 0개였다
//     pj_03 ← pp03_02  소파에서 커피
//     pj_04 ← pp05_02  매대에서 토마토를 고른다
//   ⛔ 접두어를 `pp_` 로 쓰지 않았다 — `pp_` 는 이미 «종이·라벨·씰»(유료팩)이다(`paidPacks.js:215`).
  pj_01: 0.6573, pj_02: 0.8559, pj_03: 0.9089, pj_04: 1.0279,
...
//   ⚠️ 2026-08-12 재컷(띠부씰 흰 테 2px)으로 비율이 조금 달라졌다 — PNG 를 바꾸면 여기도 «반드시» 같이.
  ...
  rs_k07: 0.9883, rs_k08: 1.0043, rs_k09: 0.9497, rs_k10: 0.8817, rs_k11: 0.846, rs_k12: 0.9457,
...
//   📌 그래서 검사가 «파일»과 «등록»을 따로 센다. 하나만 봐선 못 잡는다.
  ...
  cs_b20: 0.774, cs_b21: 1.0078, cs_b05: 1.0344, cs_b11: 0.7709, cs_b13: 1.0068,
...
// 🍂 가을 유료팩(다꾸＋수채) — 66컷
  ...
  fe_515: 1.2017,
  fe_516: 1.1486,
// 🍱 [2026-09-03] 창업자 시트 4컷 — 꽈리고추 멸치볶음 · 계란후라이간장조림 · 광어깻잎무침 · 보쌈무김치
//    ⭐ 비율은 «잰 값»이다(손으로 적지 않았다). 잘린 PNG 실측 = **가로 ÷ 세로**.
//    ⛔⛔ [2026-09-08 고침] 이 넷이 «세로÷가로» 로 뒤집혀 들어가 있었다 — 앱에서 납작하게 찌그러졌다.
//       규칙은 895줄에 적혀 있다 = ratio = 가로 ÷ 세로. 넷 다 PIL 로 다시 재서 바로잡았다.
//    ⛔ PNG 를 갈아끼우면 이 값도 다시 재야 한다 — 안 재면 앱에서 찌그러진다.
  n2701: 1.1118,
  n2702: 1.1164,
  n2703: 1.1165,
  n2704: 1.1429,
// 🌯 [2026-09-08] 창업자 시트 4컷 — 치킨부리또 · 샐러드파스타 · 무화과부라타샐러드 · 고구마치즈부리또
//    ⭐ 비율은 «잰 값»이다(PIL 실측 = 가로 ÷ 세로). ⛔ PNG 를 갈아끼우면 다시 잰다.
  n2801: 1.2105,
  n2802: 1.2233,
  n2803: 1.2155,
  n2804: 1.2139,
  ...
  fe_527: 1.2034,
  fe_528: 1.0886,
  // 🚨🚨 **[2026-09-09 00:1x · 창업자 제보] 「애호박국밥」 카드가 «빈 접시»로 떴다.**
  //   📮 창업자가 폰 화면을 보내며 = *"애호박국밥"* — 9/09 에 저절로 열린 편인데 그림 자리가 비어 있었다.
  //   🔎 뿌리 = **파일은 있는데 이 목록에 «등록»이 안 됐다.**  는 이 표의 열쇠로만 만들어지고,
  //      없는 열쇠는  가 되어 «그릇만» 그려진다. 자산을 넣고 이 표를 안 고치면 조용히 이렇게 된다.
  //   🔢 실측 = 여섯 컷이 통째로 빠져 있었다(n2901·2902·2903·2904·n0102·n0103 · 파일은 여섯 다 있다).
  //      → 족발·감자타코·어묵 당면볶음·애호박 국밥이 열리는 날마다 같은 일이 났을 것이다(10/28·11/04·9/16).
  //   ⭐ 비율은 짐작이 아니라 **파일을 열어 잰 값**이다(Pillow · 가로/세로).
  n2901: 1.2059,
  n2902: 1.2059,
  n2903: 1.2008,
  n2904: 1.2938,
  n0102: 1.1212,
  n0103: 1.1253,
  // 🍱🍱 [2026-09-11] **창업자 저장 레시피 15편에 붙는 새 컷 8개** — 오늘 자른 것.
  //   ⛔⛔ 바로 위 「애호박국밥 빈 접시」와 **똑같은 자리에 또 빠질 뻔했다.**
  //      `src/assets` 에 파일을 넣고 `FoodIcon` 갈래에 키를 넣어도, **이 표에 없으면 «빈 접시»가 그려진다.**
  //      🔢 실제로 앱을 띄워 「대파 소스 목살 덮밥」을 열었더니 표지가 빈 접시였다(2026-09-11).
  //         검수판은 파일을 직접 읽어 그리니 «멀쩡했다» — 판만 보고 넘겼으면 그대로 나갔다(규칙 21·30).
  //   ⭐ 비율은 짐작이 아니라 **파일을 열어 잰 값**이다(Pillow · 가로/세로).
  n3001: 1.2345,
  n3002: 1.2351,
  n3003: 1.2321,
...
export const STICKER_GROUPS = [
  ...
  //    ✂️ 창업자 판정 = *"1.3.4번 3개하자"* → `pf_au02`(리본 넝쿨) 뺐었다. ⛔PNG·`PHOTO_RATIO` 는 남겨 뒀다
  //    ✅✅ **[2026-09-08 창업자 다시 넣기] *"㉮로 pf_au02 서랍에 넣어줘"*** — 실물을 보고 고른 판정이다.
  //       📮 그 앞 = *"원형프레임은 있는거 다 보여줘 (가을거로만)"* → 넷을 펼쳐 보였고(pf_au01 원형 · 02 타원 ·
  //          03·04 사각), **원형 계열이 01 하나뿐**이라 02 를 살렸다. ⛔뺐던 컷을 되살릴 땐 이렇게 «이유»를 남긴다.
  { key: 'deco_autumn_frame', tab: 'frame', season: 'autumn', from: '2026-09-01', label: '가을 프레임', items: ['pf_au01', 'pf_au02', 'pf_au03', 'pf_au04'] },
  // 🖼🖼 [2026-09-01] 창업자가 «투명으로 뚫어» 보낸 프레임 12컷 — 계절이 없다(사철 기본).
  //    📮 창업자 = *"아까 자른 컷들(프레임. 포토코너, 음식) 반영"* · *"내가 다 투명으로 뚫어놓고 보낸거야"*
  //    ⭐ 가을 프레임이 셋뿐이라 창업자가 *"프레임이 다 목도리만 2개더라고 ㅠ"* 라고 했다 — 이 열둘이 그 자리를 채운다.
  //    ✂️ 창업자 판정 = *"프레임 하나 잘렸다 첫줄 리본."* → *"안되면 걔는 빼자."* → **`pf_ck02` 뺌**
  //       ⛔ 안쪽 초록 점선이 본선 «바로 안쪽»이라 흰 테(절대원칙 0.35~1.30%)가 그 위를 덮는다.
  //          `--diecut 4` 는 0.18% 라 게이트 밖이고 8px 은 auto 와 거의 같았다 — **살릴 길이 없다.**
  //       ⛔ PNG·`PHOTO_RATIO` 는 남긴다(뺀 컷은 파일을 안 지운다 · `pf_au02`·`sf_` 와 같은 방식)
  { key: 'deco_ck_frame', tab: 'frame', label: '요리 프레임', items: ['pf_ck01', 'pf_ck03', 'pf_ck04', 'pf_ck201', 'pf_ck202', 'pf_ck203', 'pf_ck204'] },
  { key: 'deco_fd_frame', tab: 'frame', label: '음식 프레임', items: ['pf_fd01', 'pf_fd02', 'pf_fd03', 'pf_fd04'] },
  // 🔖🔖 [2026-09-01] 포토코너 24컷 — 사진·종이 «모서리»에 끼우는 조각.
  //    📮 창업자 확정 = *"1번이미지는 가을 컷이라 10월에 추가할까해. 이미 9월은 나갔으니까. 2.3번은 기본으로 깔꺼라"*
  //    ⛔ 그래서 pc1_(가을)만 from 이 붙는다. pc2_·pc3_ 은 «사철 기본»이라 계절 표시를 안 준다.
  { key: 'deco_corner', tab: 'deco', label: '포토코너', items: ['pc2_01', 'pc2_02', 'pc2_03', 'pc2_04', 'pc2_05', 'pc2_06', 'pc2_07', 'pc2_08', 'pc3_01', 'pc3_02', 'pc3_03', 'pc3_04', 'pc3_05', 'pc3_06', 'pc3_07', 'pc3_08'] },
  { key: 'deco_corner_autumn', tab: 'deco', season: 'autumn', from: '2026-10-01', label: '가을 포토코너', items: ['pc1_01', 'pc1_02', 'pc1_03', 'pc1_04', 'pc1_05', 'pc1_06', 'pc1_07', 'pc1_08'] },
  ...
  // 🎁🎁 **[창업자 확정 2026-09-02] 「특별 선물」 ＋ `giftNote` 한 줄.** ⛔재론 금지
  //
  //   📮 창업자 = *"가을의 정원은 한정선물이잖아. 오해할 듯해. 매달주는걸로"*
  //      → *"12월에는 못받아야 맞지.. 특별선물인데 영원히주면 안특별하지않나.."*
  //      → ✅ *"**네가 말한대로 저 접시는 그냥 주는게 맞겠네.. 대신 매달주는거 아니라는 걸 잘 안내해줘.**"*
  //
  //   ⭐⭐ **그래서 「진짜 한정」은 «안» 만든다** — 갈래 셋을 놓고 판정한 결과다:
  //      ⓐ `until` 로 닫기 = ⛔**죽은 길.** 9월에 그 접시로 꾸미던 사람 서랍에서도 사라진다
  //         = 절대원칙 *"한 번 준 것은 빼앗지 않는다"* 정면 위반
  //      ⓑ 「받았다」를 유저별로 기록 = 되긴 한다(`ownedPacks` 구조가 있다). ⏳**나중 카드**
  //         (⛔지금은 유저가 적어 잠그면 «앞으로 오는 대다수»가 못 받는다. 우리는 모으는 단계다)
  //      ⓒ ✅**그냥 준다 ＋ 글자로 안내** ← 창업자 확정
  //
  //   ⛔⛔ **「한정」이라는 낱말은 «안» 쓴다** — `isReleased` 엔 닫는 조건이 없어서 **안 사라진다**
  //      (`season.js:64` · 서랍 필터 `DecorEditor.jsx:655`). 「한정」이라 적으면 **그 자체가 거짓말**이다.
  //   ⛔ 「한 번만 드리는 선물」도 접었다 — **「지금 안 받으면 못 받는다」로 읽힌다.**
  //      실제로는 겨울에 깔아도 받는다. 창업자 물음(*"겨울엔 새유저는 못받는거지?"*)이 그 오해를 잡아냈다.
  //
  //   ⭐ **안내는 «한 줄»이다** (창업자 = *"한줄로.. 잘 해봐봐"*) — 라벨은 이름표(알약)라 안내가 아니다.
  //      ⑴ 라벨(알약) = 「특별 선물」 — 짧아야 한다(서랍 그룹 이름 «옆»에 붙는다)
  //      ⑵ `giftNote` = **한 문장**. ⛔두 문장으로 늘리지 말 것
  //   ⭐⭐ **두 뜻이 «둘 다» 있어야 한다** — 앞절만 있으면 **「그럼 없어지나?」**가 새로 생기고,
  //      뒷절만 있으면 창업자가 시킨 «매달 아님»을 못 말한다. **둘 다 필요한데 줄은 하나다.**
  //      ⛔ 「이번에만」·「한정」 금지 — 안 사라지는데 사라진다고 말하는 게 된다(위 참조).
  //   📐📐 **「한 줄」은 «재서» 맞춘 값이다** — 첫 판(「…아니지만, 받은 건 계속 «쓸 수 있어요»」)은
  //      팝업에서 **두 줄로 넘어가 「있어요」가 외톨이로 떨어졌다**(찍어서 눈으로 확인 · 절대원칙 21).
  //      🔢 재는 자리가 «둘»이다(흉내 판이 아니라 그 element 안에서 쟀다 · 절대원칙 30 · 411px 폰)
  //         · 팝업(`NewsPopup` 13.5px) 칸 **331px** → 글 **278px** ✅
  //         · 소식 페이지(`PreviewSheet` 14px) 칸 **299px** → 글 **288px** ✅ ⭐**여기가 더 빠듯하다(여유 11px)**
  //           ⚠️ 지금은 `foldPacks` 가 꾸미기 갈래를 한 줄로 접어 소식 페이지엔 «안 뜬다» —
  //              그 달에 꾸미기 그룹이 «하나»뿐이면 접히지 않아 그때 14px 로 뜬다. 그래서 둘 다 재 둔다.
  //      ⛔ **글자 수로 어림하지 말 것** — 「·」로 끊고 「쓸 수 있어요」→「써요」로 줄여야 한 줄에 들어간다.
  //      ⭐ 그래서 이 글자를 늘리려면 **다시 재고** 늘린다(`_repro-갈라세기-0902.mjs` 가 뜻은 지키지만 «줄 수»는 안 잰다).
  { key: 'deco_gift_dish_autumn', tab: 'frame', gift: true, giftLabel: '특별 선물', giftNote: '매달 오는 선물은 아니에요 · 받은 건 계속 써요', bigCell: true, from: '2026-09-01', label: '가을의 정원 세트', hint: '직접 찍은 음식 사진을 접시에 담아보세요', items: ['pf_ad01', 'pf_ad04', 'pf_ad05', 'pf_ad08'] },
...
// 🍽🍽 **「이 레시피에 접시·액자 프레임이 깔려 있나」** (창업자 확정 2026-09-01 = 갈래 「라」)
//   📮 창업자 = *"음식아이콘을 레꾸에서 정확하게 가을의 정원으로 딱 덮었는데 **홈에서는 아이콘이 더 크네**.."*
//   🔢 실측(`_probe-접시아이콘-0901.mjs`) — 꾸미기는 «판 폭의 %»(`it.s`)라 어느 화면에서나 크기가 같은데
//      음식 그림만 홈 「자주 해먹는」에서 **0.70** 이고 나머지는 전부 **0.56** 이다
//      (레꾸 캔버스·레시피 모아보기·검색·즐겨찾기·장보기가 다 0.56).
//      → 레꾸에서 접시에 맞춰 놓은 그림이 홈에서만 **접시보다 13% 커져** 밖으로 흘러넘쳤다.
//   ⛔ 「70% 를 56% 로 되돌린다」가 답이 아니었다 — **70% 도 창업자가 시킨 값**이다
//      (2026-08-23 `1bee20df` · *"자주해먹는요리 … 조금만더크게수정."*). 그땐 접시 프레임이 없었다.
//   ✅ 그래서 **둘 다 지킨다** = 프레임을 «얹은» 레시피만 레꾸와 같은 56%, 나머지는 70% 그대로.
//   ⛔⛔ **접두어(`pf_`·`fr_`)로 가르지 않는다** — 「표시용 이름·이름 규칙은 분류 기준이 아니다」
//      (2026-07-30 여름 곰펭이 `gp_` 가 아니라서 모션이 통째로 안 붙은 그 사고). **탭으로 판정한다.**
//      → 새 프레임을 어떤 이름으로 넣든 **프레임 탭에만 넣으면** 저절로 걸린다.
//   ⭐ `drawerGroups()` 를 쓰므로 **유료팩 프레임도 산 사람에겐 같이 걸린다**(`packSplit` 이 `tab:'frame'` 을 준다).
let _frameIds = null
...
export const BOX_PAD = {
  ...
  pn101: [20.5, 7.5, 15.9, 8.4],
  pn102: [17.9, 11.0, 14.4, 9.1],
  pn103: [16.9, 13.5, 15.7, 17.1],
  pn104: [19.6, 7.2, 15.0, 7.4],
  pn201: [17.8, 6.8, 13.2, 6.5],
  pn202: [18.6, 8.0, 14.4, 8.7],
  pn203: [16.4, 6.3, 13.0, 6.3],
  pn204: [12.6, 5.9, 16.1, 5.9],
  pn301: [19.9, 9.1, 16.0, 7.4],
  pn302: [16.4, 9.4, 15.2, 9.2],
  pn303: [17.8, 6.4, 14.3, 6.4],
  pn304: [17.7, 9.4, 15.3, 9.4],
  pn401: [18.9, 7.4, 15.9, 8.7],
  pn402: [18.0, 8.3, 15.0, 11.3],
  pn403: [16.4, 8.3, 15.2, 8.3],
  pn404: [22.3, 6.4, 17.6, 6.4],

  // ⛔ 손으로 고침 — 왼쪽 달력 아이콘과 아래 밑줄을 덮었다
  dlb01: [17.0, 11.7, 30.0, 30.0],
  dlb02: [38.2, 10.6, 34.0, 10.8],
  dlb03: [23.4, 11.7, 21.9, 11.7],
  dlb04: [22.6, 9.3, 22.6, 9.5],
  dlb05: [26.9, 10.9, 25.9, 11.8],
  // ⛔ 손으로 고침 — 왼쪽 위 마테 조각을 덮었다
  dlb06: [27.3, 8.4, 18.5, 22.0],
  dlb07: [25.9, 10.8, 25.9, 11.1],
  dlb08: [18.1, 14.3, 17.6, 8.1],
  dlb09: [34.5, 8.2, 29.4, 22.3],
  dlb10: [36.4, 8.7, 13.3, 8.7],
  // ⛔ 손으로 고침 — 오른쪽 아래 하트를 덮었다
  dlb11: [26.9, 26.0, 27.6, 16.2],
  // ⛔ 손으로 고침 — 오른쪽 아래 잎사귀를 덮었다
  dlb12: [10.8, 19.5, 34.0, 19.5],
  dtp01: [21.0, 11.5, 18.7, 12.0],
  dtp02: [23.0, 11.6, 19.1, 10.7],
  dtp03: [21.1, 9.1, 21.1, 8.7],
  dtp04: [22.4, 6.9, 21.3, 6.9],
  dtp05: [25.6, 12.1, 21.7, 10.6],
  ...
  dgn03: [15.8, 10.1, 17.0, 9.1],
  dgn04: [22.4, 10.5, 30.5, 11.4],
  dgn05: [26.0, 20.9, 22.2, 13.2],   // ⛔ 손으로 — 왼쪽 위 하트를 덮었다
  dgn06: [30.0, 16.4, 14.8, 14.1],   // ⛔ 손으로 — 위쪽 집게를 덮었다
  dgn07: [21.6, 11.7, 20.5, 12.0],
  dgn08: [16.4, 8.4, 17.3, 8.4],
  dgn09: [16.9, 10.2, 18.2, 9.6],
  dgn10: [30.0, 10.1, 30.9, 9.8],
  dgn11: [27.8, 11.2, 27.8, 11.8],
  dgn12: [18.7, 12.4, 15.9, 30.0],   // ⛔ 손으로 — 왼쪽 위 리본을 덮었다

  // 📝 메모·라벨 (`dc_dma`) — 이것도 이미 앱에 있던 것
  dc_dma01: [22.8, 11.5, 15.5, 15.4],
  dc_dma05: [34.0, 26.3, 21.0, 36.7], // ⛔ 손으로 — 위쪽 마테를 덮었다
  dc_dma11: [26.7, 9.5, 25.5, 9.8],
  dc_dma07: [30.4, 13.6, 35.8, 13.3],
  dc_dma14: [34.8, 12.5, 32.0, 12.9],
  dc_dma13: [33.3, 16.7, 28.5, 17.1],
  dc_dma06: [32.4, 13.2, 30.7, 13.6],
  ...
  pf_a07: [18.8, 7.6, 10.4, 7.6],
  pf_f06: [17.0, 12.0, 14.0, 10.0],   // ⛔ 손으로 — 가운데가 뚫려 있어 자동 측정이 통째로 빗나갔다
  pf_i06: [20.5, 8.2, 13.2, 8.2],
  pf_a05: [14.7, 8.0, 14.7, 8.0],
  pf_a06: [11.1, 9.0, 10.7, 9.0],
  pf_a08: [13.1, 7.9, 12.3, 7.9],
  pf_i07: [15.6, 10.2, 15.2, 10.2],
  ...
  fn_speech: [26.0, 15.4, 34.0, 15.7],
  fn_bow: [36.1, 12.2, 31.1, 12.8],     // ⭐ 위 36% = 리본 꼬리를 피한 값이다. 더 올리면 리본에 글이 걸린다
  fn_gingham: [18.1, 10.4, 17.6, 10.8],
}
...
// ✍️✍️ **포스트잇·글 상자 전용 굵기** (창업자 확정 2026-08-31)
//
// 📮 창업자 = *"글씨 두께도 너무 얇아서 레꾸해놓으면 제목이 잘 안보여."*
//    → 후보를 실물로 보여주니 *"5번은 뭉게져 보여."* → **④(0.105em)까지가 상한**
//
// ⛔⛔ **왜 `TEXT_WEIGHTS` 를 그대로 못 쓰나** — 그 표는 **글자 스티커가 쓰고 있다.**
//    거기 `bold: 0.16` 을 낮추면 **이미 만들어 둔 레꾸의 글자 스티커까지 얇아진다**(규칙 18 ⓙ).
//    ⭐ 그래서 포스트잇 쪽만 따로 둔다. 글자 스티커는 한 글자도 안 바뀐다.
//
// 🔢 실측으로 고른 값 (`scripts/_판-글자굵기-0831.mjs` · 종이 300px · 「크게」)
//    | | 화면 stroke | 창업자 판정 |
//    |---|---|---|
//    | 지금(0.4px 고정) | 0.4px | *"제목이 잘 안보여"* |
//    | 얇게 0.025em | 1.04px | 지금과 비슷 |
//    | 보통 0.080em | 3.33px | 잘 보인다 |
//    | 굵게 0.105em | 4.37px | ✅ 여기까지 |
//    | (0.125em) | 5.20px | ⛔ *"뭉게져 보여"* |
//
// ⛔ `0.025` = 얇은 손글씨(개구·나눔펜)에 원래 붙던 «0.4px 외곽선»의 자리다.
//    px 고정이라 **글자를 키울수록 상대적으로 얇아졌다** — 그게 창업자 불만의 뿌리였다.
//    `em` 으로 바꿔 종이를 키워도 굵기가 같은 비율로 따라 자란다.
export const NOTE_FAT = { thin: 0, mid: 0.055, bold: 0.08 }
// ✍️ 손글씨 글씨체에 원래 붙던 외곽선(0.4px)의 «비율판»
export const NOTE_HAND_FAT = 0.025
