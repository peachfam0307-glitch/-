...
const CURATION_ALL = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: '우리밀 올리고당', brand: '자연드림', matches: ['올리고당'], icon: 'cu_oligo', benefit: '어느 요리나 무난하게 잘 어울려요. 꽤 오래 사용했던 템이에요', q: '올리고당', mall: 'icoop', since: '2026-08-17' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { name: '작은사이즈 고르곤졸라 · 불고기피자', brand: '우리별피자', matches: ['피자'], benefit: '가끔 인스타에서 공구할 때 사봤는데 토핑도 실하고 사이즈도 딱 좋더라구요. 모짜렐라 치즈 듬뿍 추가해서 굽는 거 추천해요. 저는 고르곤졸라·불고기피자가 제일 맛있었어요', q: '우리별피자 고르곤졸라 불고기피자', url: 'https://smartstore.naver.com/wooristar/products/6626404795', url: 'https://smartstore.naver.com/wooristar/products/6626404795', from: '2027-01-09' },
    ],
  },
]
