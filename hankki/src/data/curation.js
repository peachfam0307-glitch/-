...
const CURATION_ALL = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: '참새우젓', matches: ['새우젓'], benefit: '새우젓을 쓸 일이 많이 없는데 가끔 필요할 때 있잖아요. 작은 용량이라 냉동실에 넣어두고, 필요할 때 요긴하게 사용하고 있어요', q: '자연드림 참새우젓', mall: 'icoop', url: 'https://icoop.or.kr/coopmall/goodsmall.phtm?act=detail&gc=48041IF800', from: '2026-08-29' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: '아우노슈가', benefit: '성분 좋은 설탕이에요. 많이 달지 않아서 일반 설탕보다 조금 넉넉히 넣어도 부담 없어요. 저는 요리에 두루 이걸 써요', q: '아우노슈가', mall: 'coupang', url: 'https://link.coupang.com/a/gR0nzFheX6' },
  ...
  },
  {
    ...
    items: [
      { name: '쯔유스톡', brand: '위드잇', matches: ['쯔유'], icon: 'cu_stock_tsuyu', benefit: '성분 좋은 육수 베이스예요. 한 포씩 개별포장이라 필요한 만큼만 쓰기 편하고 유통기한도 넉넉해 구비해두기 좋아요', q: '위드잇 쯔유스톡', mall: 'coupang', url: 'https://link.coupang.com/a/gRZbWvsgEK' },
      { name: '치킨스톡', brand: '위드잇', matches: ['치킨스톡'], icon: 'cu_stock_chicken', benefit: '한 포씩 톡 넣으면 국물요리가 간편해져요. 성분 좋고 유통기한도 넉넉해 구비해두기 좋아요', q: '위드잇 치킨스톡', mall: 'coupang', url: 'https://link.coupang.com/a/gRZoLgE9Qq' },
      ...
      { name: '요리의정수 해물맛', brand: '올바른가', matches: ['해물가루육수', '가루육수'], icon: 'cu_stock_seafood', tag: '가루육수', benefit: '고체(큐브)형 육수는 모양·질감을 잡으려고 변성 성분을 넣어요. 굳이 안 먹어도 되는 첨가물이죠. 이건 가루라 성분이 깨끗하고 육수가 깔끔해요. 꽃게·새우·멸치·다시마로 낸 해물맛이라 김치찌개·국·전골에 한두 봉이면 감칠맛이 딱', q: '올바른가 요리의정수 분말육수 해물맛', mall: 'coupang', url: 'https://link.coupang.com/a/gRYLYXTa7o' },
      { name: '육수명장 분말', brand: '해통령', matches: ['해물가루육수', '가루육수'], icon: 'cu_stock_seafood', tag: '가루육수', benefit: '올바른가보다 진한 가루육수예요. 올바른가엔 꽃게가, 이건 황태가 들어 국물맛이 깔끔해요. 맛이 달라서 저는 두 가지 구비해두고 국·탕에 두루 써요. 성분도 깔끔한 편이에요', q: '해통령 육수명장 분말', mall: 'coupang', url: 'https://link.coupang.com/a/gRYOOScXZY' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: '기버터 260g', brand: '마야항아리', icon: 'cu_ghee', matches: ['기버터'], tag: '기버터', benefit: '앵커버터 100%로 만든 기버터예요. 품질이 정말 좋고 고소해서 올리브유·버터 대용으로 쓰면 좋아요. 소비기한이 짧으니 작은 병으로 담아보세요', q: '마야항아리 기버터 260g', mall: 'coupang', from: '2026-09-12', url: 'https://link.coupang.com/a/gR0o71e6tU' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: '슬라이스햄 슬림', brand: '위드잇', matches: ['슬라이스햄'], icon: 'cu_ham_slice', benefit: "첨가물 없는 '착한 스팸' 컨셉이에요. (스팸의 찐한 맛을 기대하면 조금 아쉬울 수 있어요) 데리야끼소스에 살짝 구워 무스비에 넣으면 아이 간편식으로 좋아요. 저희 애는 2주 동안 하루 한 개씩 무스비로 먹었어요", q: '위드잇 슬라이스햄 슬림', mall: 'coupang', url: 'https://link.coupang.com/a/gR0tQ4teVN' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: '건자른당면', icon: 'cu_dangmyeon', matches: ['당면'], benefit: '당면 자를 때 다 튀고 불편했는데 자른당면이 정말 편했어요. 국산 고구마 전분 100%예요', q: '자연드림 건자른당면', mall: 'icoop', from: '2026-09-19' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: '특등급 국산콩물', brand: '풀무원', matches: ['콩국물'], benefit: '한살림이 근처에 없을 때 쿠팡에서 바로 받을 수 있어요. 이건 소금간이 되어 있어서 그냥 부어 먹어도 되고, 맛을 보고 싱거우면 소금만 조금 더하면 돼요', q: '풀무원 특등급 국산콩물', mall: 'coupang',
        ...
        //       검색해 만든 것이라 ⭐위에 적은 「다른 풀무원 콩물이 먼저 뜬다」 걱정은 그대로 남는다 —
        //       ⚠️ 실물에서 엉뚱한 게 먼저 뜨면 이 줄만 되돌린다(옛 주소 = /vp/products/8769400021).
  ...
  },
  {
    ...
    items: [
      ...
      { name: '낫또', icon: 'cu_natto', matches: ['낫또'], benefit: '낫또를 썩 좋아하진 않는데 몸에 좋다고 해서 브랜드별로 거의 먹어봤어요. 그중에 자연드림 낫또가 제 입맛에는 제일 괜찮았어요. 저같은 낫또 초심자 추천', q: '자연드림 낫또', mall: 'icoop', from: '2026-09-12' },
    ],
  },
  {
    ...
    items: [
      ...
      { name: '버터치킨카레', brand: '상하농원', matches: ['카레'], benefit: '대기업 맛인데 성분이 착해요. 풍미가 부드럽고, 급할 땐 중탕해서 돈까스랑 곁들이면 든든한 한 끼가 돼요. 저는 구비해두는 카레예요', q: '상하농원 버터치킨카레', mall: 'coupang', url: 'https://link.coupang.com/a/gRZ5ovZeMe' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      { name: '간편 매생이 블럭', brand: '갯푸른', matches: ['매생이'], benefit: '하나씩 개별포장이라 필요한 만큼 쏙 꺼내 쓰기 편해요. 국·전으로 겨울 제철 맛을 간편하게 즐겨요', q: '갯푸른 간편 매생이 블럭', mall: 'coupang', url: 'https://link.coupang.com/a/gRZrVcr8JE' },
...
export const productMall = (it) => {
  ...
  const u = it.url || ''
  if (u.includes('coupang')) return '쿠팡'   // 🔗 쿠팡 파트너스 단축 링크(link.coupang.com)도 여기서 잡는다 — mall 칸이 아니라 url 로 온다
  if (u.includes('sanjitalk')) return '산지톡'
  if (u.includes('smartstore.naver') || u.includes('brand.naver')) return '네이버'
  // 🏪 [2026-09-08] 브랜드 «자사몰» — 아는 몰이 아니면 **브랜드 이름을 구매처로 쓴다.**
  //   ⛔ 전엔 여기서 빈 문자열이 나갔다 → 링크는 멀쩡한데 **배지만 빈칸**이 된다
  //      (535줄에 적힌 그 사고 — 자연드림 올리고당이 2026-08-17 부터 그 상태였다).
  //   ⭐ 몰 이름을 새로 늘리는 대신 «이미 있는 값»을 쓴다 — 자사몰은 브랜드가 곧 파는 곳이다.
  //      📮 창업자가 준 홍블랑푸드(hongblancfood.com)가 이 갈래의 첫 번째다.
  if (u && it.brand) return it.brand
  return ''
}
